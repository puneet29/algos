...
[Check for Balanced Tree](GeeksForGeeks/CheckForBalancedTree.cpp) | :heavy_check_mark: | `#tree` | [Python](GeeksForGeeks/CheckForBalancedTree.py), [C++](GeeksForGeeks/CheckForBalancedTree.cpp)
[Check if Linked List is Palindrome](GeeksForGeeks/CheckIfLinkListPallindrome.py) | :heavy_check_mark: | `#linked-list` `#pallindrome` | Python
...
[Digit Pairs](misc/DigitPairs.py) | :dove: | `#numbers` `#codevita` | Python
...
[Encode String](misc/EncodeString.py) | :heavy_check_mark: | `#strings` | Python
...
[Next Larger element](GeeksForGeeks/NextLargerElement.py) | :rocket: | `#stack` | Python
...
[Rotate a linked list](GeeksForGeeks/RotateALinkList.py) | :heavy_check_mark: | `#linked-list` | Python
...
[Set of Stacks](misc/SetOfStacks.py) | :heavy_check_mark: | `#stack` | Python
